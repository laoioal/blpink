...
<head>
<meta charset="UTF-8">
<title>blpink Join</title>
<link rel="stylesheet" type="text/css" href="/blpink/resources/css/w3.css">
<link rel="stylesheet" type="text/css" href="/blpink/resources/css/user.css">
<script type="text/javascript" src="/blpink/resources/js/jquery-3.6.0.min.js"></script>
<script type="text/javascript" src="/blpink/resources/js/blpink/join.js"></script>
<style type="text/css">
	.avtimg {
		width: 100px;
		height: 100px;
			...
			<c:if test="${data.gen eq 'M'}">
						 	<div class="avtbox">
						 		<label for="mavt${data.ano}">
						 			<img src="/blpink/resources/img/avatar/${data.savename}" class="w3-col avtimg">
						 		</label>
